...
func UpdateDatabase() {
	...
	if !ok {
		glog.Fatal("TOKEN environment variable required", token)
	}
	...
	go getPlatformData(token, KONVOYID, "kubera-saas-staging", "konvoy_pipelines", "konvoy_pipelines_jobs")    //e2e-konvoy
